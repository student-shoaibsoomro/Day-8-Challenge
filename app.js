...
console.log("Inequility test with string:", "Laptop" != "Mobile");
...
console.log('Inequility test with numericals:', 403 !== 305);
...
let Names = ['Ahmed', 'Shoaib', 'Usman', 'Faheem', 'Kabir'];
console.log('Shoaib name is in the array:', Names.includes('Shoaib'));
// Test whether an item is not in a array:
let currency = ['Dollor', 'Riyal', 'Euro', 'Pound'];
